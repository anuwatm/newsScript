...
<head>
    ...
    function enableTable(id,status){
        $("#dListUser").load("part_listTable.php?d=" + id +"&st=" + status);
    }
	/*
	$(function() {
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
			 ...
			 <div class="col-md-6">
<section class="card">
    <form id="frmScript" method="post" action="table.php">
			 <ul style="display: block;">
		<li><label>ชื่อโต๊ะ : </label><input type="hidden" name="txtEditID" id="txtEditID" value="<?php echo($edID); ?>"></input><input type="text" name="txtTableName" id="txtTableName" value="<?php echo($tableName); ?>" class="easyui-textbox" data-options="required:true" style="width:300px"></input></li>
...
<script language="javascript">
$("#dListUser").load("part_listTable.php");
</script>
</html>