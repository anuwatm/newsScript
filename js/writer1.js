...
tinymce.PluginManager.add('example', tinymce.plugins.ExamplePlugin);
	...
	tinyMCE.init({
		...
		// Theme options
		theme_advanced_buttons1 : "newScript,save,|,undo,redo,|,completeScript,approveScript,|,cut,copy,pastetext,pasteword,|,search,replace,|,undo,redo,|,cleanup,|,printScript,|removeformat,|,fullscreen,|,durationScript,|,commandScript,",
...
function getAllList(){
    ...
    $("#dListNewsTable").load("part_listNewsTable.php?t=" + $("#cboGroupSearch").val());
    $("#dListNewsProgram").load("part_listNewsMe.php");
